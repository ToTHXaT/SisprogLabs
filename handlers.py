...
from tko import TKO, Operation
from FP import first_pass
from SP import second_pass
...
def setup_handlers(mw: Ui_MainWindow):
    ...
    def pass1_handler():
        ...
        try:
            ...
            mw.src2.appendPlainText(fpr.pass1_str)
